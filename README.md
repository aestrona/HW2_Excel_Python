...
For the remote repository, make a github repository named HW2_Excel_Python, then do;

```bash
git remote add origin git@github.com:aestrona/HW2_Excel_Python.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW2_Excel_Python	<- Your notebooks and scripts will live in the main project folder
